  ...
  const handleAddService = async () => {
    ...
    try {
      const response = await axios.post(
        `/api/teacher/service-requestonline/${teacherId}`,
        {
          course,
          about,
          price,
        ...
        <form className="mx-auto mt-16 max-w-xl sm:mt-20">
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
              <label
                htmlFor="course"
                className="block text-sm font-semibold leading-6 text-blue-600 italic"
              >
                Service Subject
              </label>
            ...
            <div className="sm:col-span-2">
              ...
              <label
                htmlFor="email"
                className=" mt-2 block text-sm font-semibold leading-6 text-blue-600 italic"
              >
                Cv /Resume
              </label>
              <input
